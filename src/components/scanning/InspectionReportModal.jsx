                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-bold text-slate-600 uppercase tracking-wider">
                                        Department of Consumer Affairs • MetroLens Inspection Report
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm sm:text-base font-extrabold">
                                    {isCompliant ? 'Rule 6 & 9 Legal Metrology Compliant' : 'Reference Scale Missing / Indeterminate Status'}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="border-t-2 border-slate-300 pt-4 flex flex-wrap items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            <div className="w-20 h-20 bg-slate-100 border border-slate-300 rounded p-1 flex items-center justify-center shrink-0">
                                <img
                                    src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://metrolens.gov.in/verify/${reportId}`}
                            ...
                            <div className="space-y-1 text-xs">
                                ...
                                <p className="text-slate-600 text-[11px] leading-tight">
                                    Official digital verification hash generated by Legal Metrology AI Engine.
                                    Valid across all Govt Enforcement Nodes.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="text-right text-xs space-y-1">
                            ...
                            <p className="text-[10px] text-slate-500">Legal Metrology Dept, Govt of India</p>
                        </div>
                    </div>
